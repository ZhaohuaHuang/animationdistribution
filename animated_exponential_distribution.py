...
def update_frame(frame_number, counts, numbers, frequencies):
    ...
    show_bar_chart(f'Frequencies for {freq_sum:,} Exponential Distribution ' +
...
values = list(range(1,35))  # numbers which display on the x-axis
frequencies = [0]*34  # number frequencies which we will count
